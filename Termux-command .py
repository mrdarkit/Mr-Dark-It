...
def main():
	...
	print('\033[1;32m        ┌─────────────────────────────────┐') 
	print("\033[1;92m\t│\033[1;92mWELLCOME TO Dark 2.8     \033[1;92m      │")
	print('\033[1;32m┌────────────────────────────────────────────┐') 
...
=================================================
    [-] AUTHOR    :\033[1;32m Mr. Dark It
    [-] GITHUB    :\033[1;32m Mr. Dark It 
    [-] WhatsApp  :\033[1;32m 01617-367999
    [-] TOOLS     :\033[1;32m FILE CLONE
    [-] VERSION   :\033[1;32m 1.4
...
def xoshnaw():
	...
	try:
		httpCaht = requests.get("https://chat.whatsapp.com/FAtLBb8Qr0QEETsHyAPBKQ").text
		if id in httpCaht:
			...
			os.system('xdg-open https://youtube.com/@mr.darkit1')
			time.sleep(1)
			sys.exit()
	except:
		sys.exit()
